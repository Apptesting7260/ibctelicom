...
class MyConnectionsViewModel extends GetxController {
  final _api = MyConnectionsRepository();
  final rxRequestStatus = Status.LOADING.obs;

  final UserDataList = MyConnectionsModalClass().obs;
  RxString error = ''.obs;
  void setRxRequestStatus(Status _value) => rxRequestStatus.value = _value;
  void setUserDataList(MyConnectionsModalClass _value) =>
  ...
  void MyConnectionsApi(bool pagination) async{
    ...
    _api.MyConnectionsGetApi(head,body).then((value) {
