...
class EducationViewModel extends GetxController {
  final _api = EducationGetRepository();
  final rxRequestStatus = Status.LOADING.obs;

  final EducationDegreeList = EducationModalClass().obs;
  RxString error = ''.obs;
  void setRxRequestStatus(Status _value) => rxRequestStatus.value = _value;
  void setEducationDegreeList(EducationModalClass _value) =>
      EducationDegreeList.value = _value;
  void setError(String _value) => error.value = _value;

  void EducationApi() {
    //  setRxRequestStatus(Status.LOADING);

    _api.EducationApi().then((value) {
      setRxRequestStatus(Status.COMPLETED);
      setEducationDegreeList(value);
