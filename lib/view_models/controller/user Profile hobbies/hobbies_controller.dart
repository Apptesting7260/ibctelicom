...
class HobbiesViewModel extends GetxController {
  final _api = HobbiesGetRepository();
  final rxRequestStatus = Status.LOADING.obs;

  final HobbesList = HobbiesModalClass().obs;
  RxString error = ''.obs;
  void setRxRequestStatus(Status _value) => rxRequestStatus.value = _value;
  void setHobbiesList(HobbiesModalClass _value) => HobbesList.value = _value;
  void setError(String _value) => error.value = _value;

  void HobbiesApi() {
    //  setRxRequestStatus(Status.LOADING);

    _api.HobbiesApi().then((value) {
      setRxRequestStatus(Status.COMPLETED);
      setHobbiesList(value);
