...
class RequestTabBarBack extends StatefulWidget {
  @override
  State<RequestTabBarBack> createState() => RequestTabBarState();
}

class RequestTabBarState extends State<RequestTabBarBack>
        ...
        child: Scaffold(
          ...
          body: TabBarView(
            ...
            children: [
              ...
              OutgoingRequest(outgoingRequestList: requestList),
            ],
          ),
        ));
  }
