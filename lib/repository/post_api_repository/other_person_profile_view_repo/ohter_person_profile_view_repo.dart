...
class OtherProfileViewRepository {
  final _apiService = NetworkApiServices();

  Future<OtherProfileView_ModalClass> OtherProfileViewPostApi(
      var head, var body) async {
    dynamic response = await _apiService.postHeaderBodyApi(
        head, body, AppUrl.otherUserProfileViewApiUrl);

    return OtherProfileView_ModalClass.fromJson(response);
  }
}
