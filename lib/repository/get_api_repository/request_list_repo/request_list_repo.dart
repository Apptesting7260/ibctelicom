...
class RequestListRepository {
  ...
  Future<RequestListModalClass> RequestListGetApi(var head, var body) async {
    dynamic response = await _apiService.postHeaderBodyApi(head ,body, AppUrl.requestListApiUrl);

    return RequestListModalClass.fromJson(response);
  }
}
