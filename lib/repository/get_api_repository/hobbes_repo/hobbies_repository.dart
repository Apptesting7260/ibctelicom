...
class HobbiesGetRepository {
  final _apiService = NetworkApiServices();

  Future<HobbiesModalClass> HobbiesApi() async {
    dynamic response = await _apiService.getApi(AppUrl.hobbiesApiUrl);
    // print(response);
    return HobbiesModalClass.fromJson(response);
  }
}
